$(document).ready(function(){
    ...
    $(".change-profile-preloader").css({"display": "none"});
    $("body").on("submit", ".change-personal-info-form", function(e){
        ...
        $.ajax({
            ...
            beforeSend: function(){
                ...
                $(".change-profile-preloader").css({"display": "inline-block"});
            },
            success: function(resp){
    ...
    $(".change-password-preloader").css({"display": "none"});
    $("body").on("submit", ".change-password-form", function(e){
        ...
        if (newPassword.length <= 5){
            console.log("Password character must be 6 (six) or above.")
        }
        else if(newPassword != confirmNewPassword){
            $("#change-password-msg").html("<div class='alert alert-danger'>New confirmation password is wrong.</div>");
        }else{
            $.ajax({
                url: '/change-password/',
                method: 'POST',
                ...
                'csrfmiddlewaretoken': csrf_token,
                beforeSend: function (){
                    $(".change-password-btn").addClass({"disabled": true})
                    $(".change-password-preloader").css({"display": "inline-block"});
                },
                success: function (resp){
                    if (resp.data == 200){
                        $("#change-password-msg").show();
                        $(".change-password-preloader").css({"display": "none"});
                        $("#change-password-msg").html("<div class='alert alert-success'>Password was updated successfully.</div>");
                        setTimeout(function(){
                        ...
                        $("#change-password-msg").show();
                        $("#change-password-msg").html("<div class='alert alert-danger'>New password must be different from your existing password.</div>");
                        $(".change-password-preloader").css({"display": "none"});
                        setTimeout(function(){
                            $("#change-password-msg").fadeOut('slow');
                        }, 3000);
                        ...
                        $("#change-password-msg").show();
                        $("#change-password-msg").html("<div class='alert alert-danger'>Wrong old password entered.</div>");
                        $(".change-password-preloader").css({"display": "none"});
                        setTimeout(function(){
                            $("#change-password-msg").fadeOut('slow');
                        }, 3000);
