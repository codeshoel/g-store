$(document).ready(function(){
    ...
    // this code enables' qty input for edit
    $('body').on("click", "#edit-qty-btn", function(){
        const item_id = $(this).data('id');
        $('.edit-qty-input-'+item_id).attr('disabled', false);
        $('.apply-qty-changes-'+item_id).css({'display': 'block'});
        $('.edit-qty-btn-'+item_id).css({'display': 'none'});
    });

    // this code enables' qty input for changes to be save
    $('body').on("click", "#apply-qty-changes", function(){
        const item_id = $(this).data('id');
        $('.edit-qty-input-'+item_id).attr('disabled', true);
        $('.apply-qty-changes-'+item_id).css({'display': 'none'});
        $('.edit-qty-btn-'+item_id).css({'display': 'block'});
    });
